...
The repository contains the IOC startup configuration, HECR Modbus register map, EPICS database records, and an operator display for monitoring and controlling the device.
